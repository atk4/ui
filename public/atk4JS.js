...
var addParams = function addParams(element, options) {
    ...
    var url = options.url;
    if (!_jquery2.default.isEmptyObject(options.params)) {
        url += (url.indexOf('?') >= 0 ? '&' : '?') + _jquery2.default.param(options.params);
    }
...
var reloadView = function reloadView(element, options) {
    ...
    if (options.uri) {
        _jquery2.default.get(options.uri, options.uri_options, function (data) {
...
var _reloadView = __webpack_require__(4);
...
(0, _plugin2.default)('addParams', _addParams2.default);

_jquery2.default.addParams = function (url, data) {
    if (!_jquery2.default.isEmptyObject(data)) {
        url += (url.indexOf('?') >= 0 ? '&' : '?') + _jquery2.default.param(data);
    }
