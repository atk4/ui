...
class InlineEdit extends View
{
    ...
    public function setModel(Model $model): void
    {
        ...
        if ($this->autoSave && $this->model->isLoaded()) {
            ...
            $this->cb->set(function () use ($value) {
                try {
                    $this->model->set($this->fieldName, $this->getApp()->uip->typecastLoadField($this->model->getField($this->fieldName), $value));
                    $this->model->save();
    ...
    {
        if (!$this->autoSave) {
            $value = $this->getApp()->uip->typecastLoadField($this->model->getField($this->fieldName), $_POST['value'] ?? null);
