...
class CardSection extends View
{
     ...
     */
    public function addFields(Model $m, array $fields, bool $useLabel = false, bool $useTable = false)
    {
        if (!$m->loaded()) {
     ...
     */
    private function addSectionFields(Model $m, array $fields, bool $useLabel = false)
    {
