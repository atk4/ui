    ...
    public function getHtml()
    {
        ...
        if ($mode = $this->cb->getTriggeredValue()) {
            ...
            if ($mode === 'popup') {
                ...
                $this->getApp()->html->template->dangerouslyAppendHtml('Head', $this->getApp()->getTag('script', [], $this->getJs()));
        ...
        $this->getApp()->html->template->dangerouslyAppendHtml('Head', $this->getApp()->getTag('script', [], $this->getApp()->layout->getJs()));
