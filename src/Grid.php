...
class Grid extends View
{
    ...
    protected function init(): void
    {
        ...
        if ($this->menu !== false) {
            ...
            try {
                $menuRight = $this->menu->addMenuRight(); // @phpstan-ignore x
    ...
    private function getActionButtons(): Table\Column\ActionButtons
    {
        ...
        return $this->actionButtons; // @phpstan-ignore x
    }
    ...
    private function getActionMenu()
    {
        ...
        return $this->actionMenu; // @phpstan-ignore x
    }
    ...
    {
        $modalDefaults = is_string($title) ? ['title' => $title] : []; // @phpstan-ignore x
