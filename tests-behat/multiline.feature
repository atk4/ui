Feature: Multiline
  ...
  Scenario: contained - Crud - with unlocked DB
    ...
    Then I check if text in "//table//tr[1]/td[2]" match regex "~\"atk_fp_tbl__country_id\":10[,}]~"
    Then I check if text in "//table//tr[1]/td[2]" match regex "~\"atk_fp_tbl__qty\":\"5\"~"
    Then I check if text in "//table//tr[1]/td[2]" match regex "~\"atk_fp_tbl__box\":\"6\"~"
    Then I check if text in "//table//tr[1]/td[3]" match regex "~^\[\{.+,\"atk_fp_tbl__item\":\"Pear\",~"
    Then I check if text in "//table//tr[1]/td[3]" match regex "~\"atk_fp_tbl__country_id\":null~"
    Then I check if text in "//table//tr[1]/td[3]" match regex "~\"atk_fp_tbl__qty\":\"7\"~"
    Then I check if text in "//table//tr[1]/td[3]" match regex "~\"atk_fp_tbl__box\":\"8\"~"
    ...
    Then I check if text in "//table//tr[1]/td[2]" match regex "~^\[\{.+,\"atk_fp_tbl__item\":\"Melon\",~"
    Then I check if text in "//table//tr[1]/td[2]" match regex "~\"atk_fp_tbl__country_id\":10[,}]~"
    Then I check if text in "//table//tr[1]/td[2]" match regex "~\"atk_fp_tbl__qty\":\"9\"~"
    Then I check if text in "//table//tr[1]/td[2]" match regex "~\"atk_fp_tbl__box\":\"6\"~"
    Then I check if text in "//table//tr[1]/td[3]" match regex "~^\[\{.+,\"atk_fp_tbl__item\":\"Pear\",~"
    Then I check if text in "//table//tr[1]/td[3]" match regex "~\"atk_fp_tbl__country_id\":null~"
    Then I check if text in "//table//tr[1]/td[3]" match regex "~\"atk_fp_tbl__qty\":\"7\"~"
