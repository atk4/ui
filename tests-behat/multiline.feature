Feature: Multiline
  ...
  Scenario: contained - Crud - with unlocked DB
    ...
    Then I check if text in "//table//tr[1]/td[3]" match regex "~^\[\{.+,\"atk_fp_tbl__item\":\"Pear\",~"
    Then I check if text in "//table//tr[1]/td[3]" match regex "~,\"atk_fp_tbl__country_id\":null,\"atk_fp_tbl__qty\":\"7\",\"atk_fp_tbl__box\":\"8\"\}\]$~"

    When I click using selector "//table//tr[1]//i.icon.edit"
    When I fill field using "(//div.field[label[text()='Item']])[2]//div[@name=\"-atk_fp_tbl__qty\"]/input" with "9"
    When I press Modal button "Save"
    Then Toast display should contain text "Record has been saved!"
    Then I check if text in "//table//tr[1]/td[2]" match regex "~,\"atk_fp_tbl__country_id\":10,\"atk_fp_tbl__qty\":\"9\",\"atk_fp_tbl__box\":\"6\"\}\]$~"
    Then I check if text in "//table//tr[1]/td[3]" match regex "~,\"atk_fp_tbl__country_id\":null,\"atk_fp_tbl__qty\":\"7\",\"atk_fp_tbl__box\":\"8\"\}\]$~"
