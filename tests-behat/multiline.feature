Feature: Multiline
  ...
  Scenario: dropdown enum
    ...
    When I check if text in "//div.text[parent::div[@name='-age1']]" match text "1"
    When I check if text in "//div.text[parent::div[@name='-age2']]" match text "2"
    When I check if text in "//div.text[parent::div[@name='-age3']]" match text "3"
    When I check if text in "textarea[name=-text]" match text "a\nb"
    When I press button "Save"
    Then Toast display should contain text "[ { \"id\": null, \"age0\": null, \"age1\": 1, \"age2\": 2, \"age3\": 3, \"text\": \"a\\nb\" } ]"

    When I select "Child" in lookup "//div.text[parent::div[@name='-age0']]"
    When I select "Adult" in lookup "//div.text[parent::div[@name='-age1']]"
    When I select "Child" in lookup "//div.text[parent::div[@name='-age2']]"
    When I select "Child" in lookup "//div.text[parent::div[@name='-age3']]"
    ...
    When I check if text in "//div.text[parent::div[@name='-age2']]" match text "Child"
    When I check if text in "//div.text[parent::div[@name='-age3']]" match text "Child"
    When I check if text in "textarea[name=-text]" match text "a\n b"
    When I press button "Save"
    Then Toast display should contain text "[ { \"id\": null, \"age0\": 1, \"age1\": 2, \"age2\": 1, \"age3\": 1, \"text\": \"a\\n b\" } ]"
