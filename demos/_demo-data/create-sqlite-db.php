...
(new \atk4\schema\Migration($model))->dropIfExists()->create();
$model->import([
    ['id' => 1, 'name' => 'phpunit.xml', 'type' => 'xml', 'is_folder' => 0, 'parent_folder_id' => ''],
    ['id' => 2, 'name' => 'LICENSE', 'type' => '', 'is_folder' => 0, 'parent_folder_id' => ''],
    ['id' => 3, 'name' => 'Makefile', 'type' => '', 'is_folder' => 0, 'parent_folder_id' => ''],
    ['id' => 4, 'name' => 'tests', 'type' => '', 'is_folder' => 1, 'parent_folder_id' => ''],
    ['id' => 5, 'name' => 'TemplateTest.php', 'type' => 'php', 'is_folder' => 0, 'parent_folder_id' => 4],
    ['id' => 6, 'name' => 'template', 'type' => '', 'is_folder' => 1, 'parent_folder_id' => ''],
    ...
    ['id' => 16, 'name' => 'docs', 'type' => '', 'is_folder' => 1, 'parent_folder_id' => ''],
    ...
    ['id' => 32, 'name' => 'README.md', 'type' => 'md', 'is_folder' => 0, 'parent_folder_id' => ''],
    ['id' => 33, 'name' => 'demos', 'type' => '', 'is_folder' => 1, 'parent_folder_id' => ''],
    ...
    ['id' => 45, 'name' => 'composer.json', 'type' => 'json', 'is_folder' => 0, 'parent_folder_id' => ''],
    ['id' => 46, 'name' => 'src', 'type' => '', 'is_folder' => 1, 'parent_folder_id' => ''],
