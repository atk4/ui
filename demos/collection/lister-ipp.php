...
{List}<div class="ui icon label"><i class="{$xxx_iso} flag"></i> {$xxx_name}</div>{/}
</div>')]);
...
{List}<div class="ui icon label"><i class="{$xxx_iso} flag"></i> {$xxx_name}</div>{empty}no flags to show here{/}{/}
</div>')]);
