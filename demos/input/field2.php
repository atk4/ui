...
$group->addField('text_norm', [new Form\Control\Textarea()])->set('editable');
$group->addField('text_read', [new Form\Control\Textarea(), 'readonly' => true])->set('read only');
$group->addField('text_disb', [new Form\Control\Textarea(), 'disabled' => true])->set('disabled');

$group = $form->addGroup('Checkbox');
$group->addField('c_norm', [new Form\Control\Checkbox()])->set(true);
$group->addField('c_read', [new Form\Control\Checkbox(), 'readonly' => true])->set(true); // allows to change value
$group->addField('c_disb', [new Form\Control\Checkbox(), 'disabled' => true])->set(true); // input is not disabled
...
$group->addField('d_norm', [new Form\Control\Dropdown(['values' => $values]), 'width' => 'three'])->set('globe');
$group->addField('d_read', [new Form\Control\Dropdown(['values' => $values]), 'readonly' => true, 'width' => 'three'])->set('globe'); // allows to change value
$group->addField('d_disb', [new Form\Control\Dropdown(['values' => $values]), 'disabled' => true, 'width' => 'three'])->set('globe'); // css disabled, but can focus with Tab and change value

$group = $form->addGroup('Radio');

$group->addField('radio_norm', [Form\Control\Radio::class], ['enum' => ['one', 'two', 'three']])->set('two');
$group->addField('radio_read', [Form\Control\Radio::class, 'readonly' => true], ['enum' => ['one', 'two', 'three']])->set('two');
$group->addField('radio_disb', [Form\Control\Radio::class, 'disabled' => true], ['enum' => ['one', 'two', 'three']])->set('two');
...
$field = $group->addField('file_norm', [Form\Control\Upload::class, ['accept' => ['.png', '.jpg']]])->set('normal', 'normal.jpg');
$field->onDelete($onDelete);
$field->onUpload($onUpload);

$field = $group->addField('file_read', [Form\Control\Upload::class, ['accept' => ['.png', '.jpg'], 'readonly' => true]])->set('readonly', 'readonly.jpg');
$field->onDelete($onDelete);
$field->onUpload($onUpload);

$field = $group->addField('file_disb', [Form\Control\Upload::class, ['accept' => ['.png', '.jpg'], 'disabled' => true]])->set('disabled', 'disabled.jpg');
$field->onDelete($onDelete);
$field->onUpload($onUpload);
...
$group->addField('calendar_norm', [Form\Control\Calendar::class, 'type' => 'date'])->set(date($app->ui_persistence->date_format));
$group->addField('calendar_read', [Form\Control\Calendar::class, 'type' => 'date', 'readonly' => true])->set(date($app->ui_persistence->date_format));
$group->addField('calendar_disb', [Form\Control\Calendar::class, 'type' => 'date', 'disabled' => true])->set(date($app->ui_persistence->date_format));
...
$field = $form->addField('name', [Form\Control\Line::class, 'hint' => 'this is sample hint that escapes <html> characters']);
$field->set('value in a form');

$field = $form->addField('surname', new Form\Control\Line([
...
$form_page->addField('name', new Form\Control\Line());

$form_page = Form\Layout::addTo($tabs->addTab('Other Info'), ['form' => $form]);
$form_page->addField('age', new Form\Control\Line());
...
$group = $form->addGroup('Calendar');
$c1 = $group->addField('c1', new Form\Control\Calendar(['type' => 'date']));
$c2 = $group->addField('c2', new Form\Control\Calendar(['type' => 'date']));
$c3 = $group->addField('c3', new Form\Control\Calendar(['type' => 'date']));
...
$group = $form->addGroup('CheckBox');
$b1 = $group->addField('b1', new Form\Control\Checkbox());
$b1->onChange('console.log("b1 changed")');

$group = $form->addGroup(['Dropdown', 'width' => 'three']);
$d1 = $group->addField('d1', new Form\Control\Dropdown(['values' => [
    'tag' => ['Tag', 'icon' => 'tag icon'],
    'globe' => ['Globe', 'icon' => 'globe icon'],
    'registered' => ['Registered', 'icon' => 'registered icon'],
    'file' => ['File', 'icon' => 'file icon'],
...
$group = $form->addGroup('Radio');
$r1 = $group->addField('r1', new Form\Control\Radio(['values' => [
    'Tag',
    'Globe',
    'Registered',
    'File',
...
$group->addField('text_crlf', [new Form\Control\Textarea()])->set("First line\r\nSecond line");
$group->addField('text_cr', [new Form\Control\Textarea()])->set("First line\rSecond line");
$group->addField('text_lf', [new Form\Control\Textarea()])->set("First line\nSecond line");

$group = $form->addGroup('With model');
$group->addField('m_text_crlf', [new Form\Control\Textarea()], ['type' => 'text'])->set("First line\r\nSecond line");
$group->addField('m_text_cr', [new Form\Control\Textarea()], ['type' => 'text'])->set("First line\rSecond line");
$group->addField('m_text_lf', [new Form\Control\Textarea()], ['type' => 'text'])->set("First line\nSecond line");
