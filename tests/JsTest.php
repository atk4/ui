...
class JsTest extends TestCase
{
    ...
    public function testChain1(): void
    {
        ...
        $c->getTextInRange('start', 'end'); // @phpstan-ignore x
    ...
    {
        $c = new JsChain('$myInput');
        $c->getTextInRange(new JsExpression('getStart()'), 'end'); // @phpstan-ignore x
    ...
    public function testBlockInvalidStringTypeException(): void
    {
        ...
        new JsBlock(['a()']); // @phpstan-ignore x
    }
